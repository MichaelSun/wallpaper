...
//     * @param context Context.
//     * @param title   The title of this AlertDialog can be null .
//     * @param icons   icon src list.
//     * @param items   text list.
//     * @param alertDo methods call Id.
//     * @param cancel  Name can be null.It will be Red Color
//     * @return A Dialog
//     */
//    public static Dialog showShareAlert(final Context context, final String title, final int[] icons, final String[] items, String cancel, final OnAlertSelectId alertDo, OnCancelListener cancelListener) {
//        if (TextUtils.isEmpty(cancel)) {
//            cancel = context.getString(R.string.app_cancel);
//        }
//        final Dialog dlg = new Dialog(context, R.style.MMTheme_DataSheet);
//        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
//        LinearLayout layout = (LinearLayout) inflater.inflate(R.layout.alert_dialog_menu_share_layout, null);
//        final int cFullFillWidth = 10000;
//        layout.setMinimumWidth(cFullFillWidth);
//
//        final TextView titleTv = (TextView) layout.findViewById(R.id.popup_title);
...
//        }
//        final TextView cancelBtn = (TextView) layout.findViewById(R.id.popup_cancel);
...
//        });
//
//        final GridView grid = (GridView) layout.findViewById(R.id.content_grid);
//        ShareAdapter adapter = new ShareAdapter(context, icons, items);
...
//    }
    ...
    public static Dialog showAlertDialog(final Context context, final String title,String msg, String confirm, String cancel, View.OnClickListener listener) {
        if (TextUtils.isEmpty(cancel)) {
            cancel = context.getString(R.string.app_cancel);
        }
        final Dialog dlg = new Dialog(context, R.style.MMTheme_DataSheet);
        ...
        final TextView msgTv = (TextView) layout.findViewById(R.id.popup_msg);
        ...
        final TextView confirmBtn = (TextView) layout.findViewById(R.id.popup_confirm);
